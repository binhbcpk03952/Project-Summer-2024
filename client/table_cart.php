                ...
                <div class="col-md-6">
                    <div class="product_content">
                        ...
                        <form id="product-form-<?php echo $product_id; ?>">
                            ...
                            <div class="product_color">
                                ...
                                <div class="button-group" id="color-group-<?php echo $product_id; ?>">
                                    ...
                                    <button type="button" class="btn"
                                        ...
                                        onclick="selectColor('<?php echo $product_id; ?>', '<?php echo htmlspecialchars($color); ?>', event)"></button>
                                    <?php endforeach; ?>
                                </div>
                            ...
                            <button type="button" class="btn btn-dark w-100 mt-5 fw-bold rounded-0"
                                onclick="submitForm('<?php echo $product_id; ?>')">Thêm vào giỏ hàng</button>
                        </form>
                        <?php endforeach; ?>
                        <div class="description mt-5">
                            <span class="description_heading fw-bold">MÔ TẢ</span>
                            <hr class="m-0">
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea cumque maiores similique fu
                            </p>
                        </div>
                    </div>
                </div>
