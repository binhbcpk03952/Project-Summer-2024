        ...
        <main>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="start-item">
                                <img
                                    src="https://owen.cdn.vccloud.vn/media/amasty/ampromobanners/Artboard_2-100_210524.jpg"
                                    alt>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="start-item">
                                <img
                                    src="https://owen.cdn.vccloud.vn/media/amasty/ampromobanners/Artboard_2_copy-100_210524.jpg"
                                    alt>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="start-item">
                                <img
                                    src="https://owen.cdn.vccloud.vn/media/amasty/ampromobanners/Artboard_2_copy_2-100_210524.jpg"
                                    alt>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container mt-4">
                <div class="row banner-2">
                    <img
                        src="https://owen.cdn.vccloud.vn/media/codazon/slideshow/a/r/artboard_5-100_210524.jpg"
                        alt>
                </div>
            </div>
                            ...
                            <div class="products-item">
                                <div class="image-product">
                                    <a href="#" class="image-product-links">
                                        <img
                                            src="https://owen.cdn.vccloud.vn/media/catalog/product/cache/01755127bd64f5dde3182fd2f139143a/a/p/apv231316.jpg"
                                            alt class>
                                    </a>
                                    <a href="#"
                                        class="btn btn_add--checkout px-4">MUA
                                        NGAY</a>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="products-item">
                                <div class="image-product">
                                    <a href="#" class="image-product-links">
                                        <img
                                            src="https://owen.cdn.vccloud.vn/media/catalog/product/cache/01755127bd64f5dde3182fd2f139143a/s/w/sw231917.jpg"
                                            alt class>
                                    </a>
                                    <a href="#"
                                        class="btn btn_add--checkout px-4">MUA
                        ...
                        <div class="col-md-3">
                            <div class="products-item">
                                <div class="image-product">
                                    <a href="#" class="image-product-links">
                                        <img
                                            src="https://owen.cdn.vccloud.vn/media/catalog/product/cache/01755127bd64f5dde3182fd2f139143a/a/p/apt231406_2_.jpg"
                                            alt class>
                                    </a>
                                    <a href="#"
                                        class="btn btn_add--checkout px-4">MUA
                        ...
                        <div class="col-md-3">
                            <div class="products-item">
                                <div class="image-product">
                                    <a href="#" class="image-product-links">
                                        <img
                                            src="https://owen.cdn.vccloud.vn/media/catalog/product/cache/01755127bd64f5dde3182fd2f139143a/a/e/ae240008n_1.jpg"
                                            alt class>
                                    </a>
                                    <a href="#"
                                        class="btn btn_add--checkout px-4">MUA
            ...
            <div class="banner-suit container mt-5">
                <a href="#">
                    <img
                        src="https://owen.cdn.vccloud.vn/media/amasty/ampromobanners/Artboard_7-100_210524_1.jpg"
                        alt class="w-100">
                </a>
            </div>
            <section>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="image-left-form">
                                <img
                                    src="https://owen.cdn.vccloud.vn/media/amasty/ampromobanners/Artboard_10-100_210524.jpg"
                                    alt class="w-100">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-status px-4 p-5">
                                ...
                                <form action class="pb-4">
                                    ...
                                    <button
                                        class="w-100 bg-dark btn text-white mt-4 fw-bold register-end mb-4">ĐĂNG
                                        KÍ</button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="address">
                                ...
                                <div class="info-footer">
                                    ...
                                    <p><span class="fw-bold">Hotline</span>:
                                        1900 1000</p>
                                </div>
                                <div class="address-footer">
                                    <p class="m-0"><span class="fw-bold">VP Phía
                                            Bắc</span>: Tầng 17 tòa nhà
                                        Viwaseen, 48 Phố Tố Hữu, Trung Văn, Nam
                                        Từ Liêm,
                                        Hà Nội.</p>
                                    <p><span class="fw-bold">VP Phía Nam</span>:
                                        186A Nam Kỳ Khởi Nghĩa, Phường Võ Thị
                                        Sáu, Quận 3, TP.HCM</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 mt-5">
                            <div class="footer-items mt-5">
                                <h5 class="fs-6 fw-bold">GIỚI THIỆU VỀ
                                    PRINCES</h5>
                                <ul>
                                    <li class="nav-link">
                                        <a href="#">Giới thiệu</a>
                            ...
                            <div class="footer-items mt-5">
                                ...
                                <div class="face-ins d-flex">
                                    <a href="#" class="nav-link ml-2">
                                        <i
                                            class="fa-brands fa-facebook fs-4"></i>
                                    </a>
                                    <a href="#" class="nav-link ms-2">
                                        <i
                                            class="fa-brands fa-instagram fs-4"></i>
                                    </a>
                                    <a href="#" class="nav-link ms-2">
                                        <i
