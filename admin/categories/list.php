...
<div class="d-flex justify-content-between mt-4">
    ...
    <div class="add-category">
        <a href="index.php?view=category_created" class="btn color-bg text-white px-4 mx-5">Thêm danh mục</a>
    </div>
</div>
<table class="table">
    <thead>
    ...
    <tbody>
        <?php foreach ($category as $category) { ?>
            <tr>
                ...
                <td>
                    <div class="action">
                        <a href="index.php?view=category_update&id=<?php echo $category['idCategories'] ?>" class="update_category text-decoration-none fw-bold mx-2">Cập nhật</a>
                        <a href="index.php?view=category_delete&id=<?php echo $category['idCategories'] ?>" class="remove_category
