                        ...
                        <div class="col-md-6">
                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Tên người dùng" value="<?php echo htmlspecialchars($user['name']); ?>">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="username" class="form-control" placeholder="username" value="<?php echo htmlspecialchars($user['username']); ?>">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="password" class="form-control" placeholder="Mật khẩu (để trống nếu không đổi)" value="<?php echo htmlspecialchars($user['password']); ?>">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="email" value="<?php echo htmlspecialchars($user['email']); ?>">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control" placeholder="Số điện thoại" value="<?php echo htmlspecialchars($user['phone']); ?>">
                                    <?php
                                ...
                                <div class="image mb-3">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <img class="mt-3" src="image/<?php echo htmlspecialchars($user['image']); ?>" alt="">
                                </div>
                                <div class="role mb-3">
                                ...
                                <div class="status mb-3">
                                    <label for="">Trạng thái hoạt động</label><br>
                                        <input type="radio" name="status" id="" value="Đang hoạt động" checked> Hoạt động<br>
                                        <input type="radio" name="status" id="" value="Ngừng hoạt động"> Ngừng hoạt động <br>
                                        <?php
